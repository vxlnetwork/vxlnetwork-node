...
namespace ipc
{
	...
	public:
		 ...
		 */
		std::string path{ "/tmp/vxlnetwork" };
	};
	...
	{
	public:
		ipc_config_tcp_socket (vxlnetwork::network_constants & network_constants) :
	...
	{
	public:
		ipc_config (vxlnetwork::network_constants & network_constants) :

...
namespace ipc
{
	 ...
	 * @throws Methods of this class throw vxlnetwork::error on failure.
	...
	public:
		 ...
		 */
		flatbuffers_handler (vxlnetwork::node & node_a, vxlnetwork::ipc::ipc_server & ipc_server_a, std::shared_ptr<vxlnetwork::ipc::subscriber> const & subscriber_a, vxlnetwork::ipc::ipc_config const & ipc_config_a);
		 ...
		 */
		static std::shared_ptr<flatbuffers::Parser> make_flatbuffers_parser (vxlnetwork::ipc::ipc_config const & ipc_config_a);
	...
	private:
		...
		vxlnetwork::ipc::ipc_config const & ipc_config;
	};
}
}

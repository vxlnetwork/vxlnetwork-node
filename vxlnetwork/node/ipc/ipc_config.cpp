...
vxlnetwork::error vxlnetwork::ipc::ipc_config::serialize_toml (vxlnetwork::tomlconfig & toml) const
{
	vxlnetwork::tomlconfig tcp_l;
	...
	vxlnetwork::tomlconfig domain_l;
	...
	vxlnetwork::tomlconfig flatbuffers_l;
...
vxlnetwork::error vxlnetwork::ipc::ipc_config::deserialize_toml (vxlnetwork::tomlconfig & toml)
{

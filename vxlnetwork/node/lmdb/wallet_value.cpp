...
vxlnetwork::wallet_value::wallet_value (vxlnetwork::db_val<MDB_val> const & val_a)
{
...
vxlnetwork::wallet_value::wallet_value (vxlnetwork::raw_key const & key_a, uint64_t work_a) :
	key (key_a),
	work (work_a)
{
}

vxlnetwork::db_val<MDB_val> vxlnetwork::wallet_value::val () const
{
	static_assert (sizeof (*this) == sizeof (key) + sizeof (work), "Class not packed");
	return vxlnetwork::db_val<MDB_val> (sizeof (*this), const_cast<vxlnetwork::wallet_value *> (this));
}

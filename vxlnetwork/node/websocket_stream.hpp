...
#include <vxlnetwork/boost/beast/core.hpp>
#include <vxlnetwork/boost/beast/websocket.hpp>
...
namespace vxlnetwork::websocket
{
/** The minimal stream interface needed by the Vxlnetwork websocket implementation */
...
public:
	...
	virtual void async_write (vxlnetwork::shared_const_buffer const & buffer_a, std::function<void (boost::system::error_code, std::size_t)> callback_a) = 0;

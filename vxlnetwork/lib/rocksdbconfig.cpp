...
vxlnetwork::error vxlnetwork::rocksdb_config::serialize_toml (vxlnetwork::tomlconfig & toml) const
{
...
vxlnetwork::error vxlnetwork::rocksdb_config::deserialize_toml (vxlnetwork::tomlconfig & toml)
{
...
bool vxlnetwork::rocksdb_config::using_rocksdb_in_tests ()
{

...
public:
	timer () = default;
	timer (vxlnetwork::timer_state state_a, std::string const & description_a = "timer");
	...
	vxlnetwork::timer_state current_state () const;

private:
	timer * parent{ nullptr };
	std::vector<timer> children;
	vxlnetwork::timer_state state{ vxlnetwork::timer_state::stopped };
	std::string desc;

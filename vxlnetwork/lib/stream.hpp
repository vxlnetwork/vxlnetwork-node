...
template <typename T>
bool try_read (vxlnetwork::stream & stream_a, T & value_a)
{
...
template <typename T>
void read (vxlnetwork::stream & stream_a, T & value)
{
...
inline void read (vxlnetwork::stream & stream_a, std::vector<uint8_t> & value_a, size_t size_a)
{
...
template <typename T>
void write (vxlnetwork::stream & stream_a, T const & value_a)
{
...
inline void write (vxlnetwork::stream & stream_a, std::vector<uint8_t> const & value_a)
{

...
std::vector<std::string> vxlnetwork::config_overrides (std::vector<config_key_value_pair> const & key_value_pairs_a)
{
...
std::istream & vxlnetwork::operator>> (std::istream & is, vxlnetwork::config_key_value_pair & into)
{
	char ch;
	while (is >> ch && ch != '=')
	{

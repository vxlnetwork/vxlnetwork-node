...
vxlnetwork::error vxlnetwork::diagnostics_config::serialize_toml (vxlnetwork::tomlconfig & toml) const
{
	vxlnetwork::tomlconfig txn_tracking_l;
...
vxlnetwork::error vxlnetwork::diagnostics_config::deserialize_toml (vxlnetwork::tomlconfig & toml)
{

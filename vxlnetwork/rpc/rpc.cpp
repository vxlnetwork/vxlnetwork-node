...
vxlnetwork::rpc::rpc (boost::asio::io_context & io_ctx_a, vxlnetwork::rpc_config config_a, vxlnetwork::rpc_handler_interface & rpc_handler_interface_a) :
...
void vxlnetwork::rpc::accept ()
{
	auto connection (std::make_shared<vxlnetwork::rpc_connection> (config, io_ctx, logger, rpc_handler_interface));
...
void vxlnetwork::rpc::stop ()
{
	stopped = true;
	acceptor.close ();
}

std::unique_ptr<vxlnetwork::rpc> vxlnetwork::get_rpc (boost::asio::io_context & io_ctx_a, vxlnetwork::rpc_config const & config_a, vxlnetwork::rpc_handler_interface & rpc_handler_interface_a)
{

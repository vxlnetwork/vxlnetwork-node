...
#ifndef FLATBUFFERS_GENERATED_VXLNETWORKAPI_VXLNETWORKAPI_H_
#define FLATBUFFERS_GENERATED_VXLNETWORKAPI_VXLNETWORKAPI_H_

#include "flatbuffers/flatbuffers.h"

namespace vxlnetworkapi {
...
template<> struct BlockTraits<vxlnetworkapi::BlockState> {
  static const Block enum_value = Block_BlockState;
};

template<> struct BlockTraits<vxlnetworkapi::BlockOpen> {
  static const Block enum_value = Block_BlockOpen;
};

template<> struct BlockTraits<vxlnetworkapi::BlockReceive> {
  static const Block enum_value = Block_BlockReceive;
};

template<> struct BlockTraits<vxlnetworkapi::BlockSend> {
  static const Block enum_value = Block_BlockSend;
};

template<> struct BlockTraits<vxlnetworkapi::BlockChange> {
...
struct BlockUnion {
  ...
  BlockUnion(const BlockUnion &);
  BlockUnion &operator=(const BlockUnion &u)
  ...
  vxlnetworkapi::BlockStateT *AsBlockState() {
    return type == Block_BlockState ?
      reinterpret_cast<vxlnetworkapi::BlockStateT *>(value) : nullptr;
  }
  const vxlnetworkapi::BlockStateT *AsBlockState() const {
    return type == Block_BlockState ?
      reinterpret_cast<const vxlnetworkapi::BlockStateT *>(value) : nullptr;
  }
  vxlnetworkapi::BlockOpenT *AsBlockOpen() {
    return type == Block_BlockOpen ?
      reinterpret_cast<vxlnetworkapi::BlockOpenT *>(value) : nullptr;
  }
  const vxlnetworkapi::BlockOpenT *AsBlockOpen() const {
    return type == Block_BlockOpen ?
      reinterpret_cast<const vxlnetworkapi::BlockOpenT *>(value) : nullptr;
  }
  vxlnetworkapi::BlockReceiveT *AsBlockReceive() {
    return type == Block_BlockReceive ?
      reinterpret_cast<vxlnetworkapi::BlockReceiveT *>(value) : nullptr;
  }
  const vxlnetworkapi::BlockReceiveT *AsBlockReceive() const {
    return type == Block_BlockReceive ?
      reinterpret_cast<const vxlnetworkapi::BlockReceiveT *>(value) : nullptr;
  }
  vxlnetworkapi::BlockSendT *AsBlockSend() {
    return type == Block_BlockSend ?
      reinterpret_cast<vxlnetworkapi::BlockSendT *>(value) : nullptr;
  }
  const vxlnetworkapi::BlockSendT *AsBlockSend() const {
    return type == Block_BlockSend ?
      reinterpret_cast<const vxlnetworkapi::BlockSendT *>(value) : nullptr;
  }
  vxlnetworkapi::BlockChangeT *AsBlockChange() {
    return type == Block_BlockChange ?
      reinterpret_cast<vxlnetworkapi::BlockChangeT *>(value) : nullptr;
  }
  const vxlnetworkapi::BlockChangeT *AsBlockChange() const {
    return type == Block_BlockChange ?
      reinterpret_cast<const vxlnetworkapi::BlockChangeT *>(value) : nullptr;
  }
};
...
enum TopicConfirmationTypeFilter : int8_t {
...
enum TopicConfirmationType : int8_t {
...
template<> struct MessageTraits<vxlnetworkapi::Error> {
  static const Message enum_value = Message_Error;
};

template<> struct MessageTraits<vxlnetworkapi::Success> {
  static const Message enum_value = Message_Success;
};

template<> struct MessageTraits<vxlnetworkapi::IsAlive> {
  static const Message enum_value = Message_IsAlive;
};

template<> struct MessageTraits<vxlnetworkapi::EventAck> {
  static const Message enum_value = Message_EventAck;
};

template<> struct MessageTraits<vxlnetworkapi::BlockInfo> {
  static const Message enum_value = Message_BlockInfo;
};

template<> struct MessageTraits<vxlnetworkapi::AccountWeight> {
  static const Message enum_value = Message_AccountWeight;
};

template<> struct MessageTraits<vxlnetworkapi::AccountWeightResponse> {
  static const Message enum_value = Message_AccountWeightResponse;
};

template<> struct MessageTraits<vxlnetworkapi::TopicConfirmation> {
  static const Message enum_value = Message_TopicConfirmation;
};

template<> struct MessageTraits<vxlnetworkapi::EventConfirmation> {
  static const Message enum_value = Message_EventConfirmation;
};

template<> struct MessageTraits<vxlnetworkapi::ServiceRegister> {
  static const Message enum_value = Message_ServiceRegister;
};

template<> struct MessageTraits<vxlnetworkapi::ServiceStop> {
  static const Message enum_value = Message_ServiceStop;
};

template<> struct MessageTraits<vxlnetworkapi::TopicServiceStop> {
  static const Message enum_value = Message_TopicServiceStop;
};

template<> struct MessageTraits<vxlnetworkapi::EventServiceStop> {
...
struct MessageUnion {
  ...
  vxlnetworkapi::ErrorT *AsError() {
    return type == Message_Error ?
      reinterpret_cast<vxlnetworkapi::ErrorT *>(value) : nullptr;
  }
  const vxlnetworkapi::ErrorT *AsError() const {
    return type == Message_Error ?
      reinterpret_cast<const vxlnetworkapi::ErrorT *>(value) : nullptr;
  }
  vxlnetworkapi::SuccessT *AsSuccess() {
    return type == Message_Success ?
      reinterpret_cast<vxlnetworkapi::SuccessT *>(value) : nullptr;
  }
  const vxlnetworkapi::SuccessT *AsSuccess() const {
    return type == Message_Success ?
      reinterpret_cast<const vxlnetworkapi::SuccessT *>(value) : nullptr;
  }
  vxlnetworkapi::IsAliveT *AsIsAlive() {
    return type == Message_IsAlive ?
      reinterpret_cast<vxlnetworkapi::IsAliveT *>(value) : nullptr;
  }
  const vxlnetworkapi::IsAliveT *AsIsAlive() const {
    return type == Message_IsAlive ?
      reinterpret_cast<const vxlnetworkapi::IsAliveT *>(value) : nullptr;
  }
  vxlnetworkapi::EventAckT *AsEventAck() {
    return type == Message_EventAck ?
      reinterpret_cast<vxlnetworkapi::EventAckT *>(value) : nullptr;
  }
  const vxlnetworkapi::EventAckT *AsEventAck() const {
    return type == Message_EventAck ?
      reinterpret_cast<const vxlnetworkapi::EventAckT *>(value) : nullptr;
  }
  vxlnetworkapi::BlockInfoT *AsBlockInfo() {
    return type == Message_BlockInfo ?
      reinterpret_cast<vxlnetworkapi::BlockInfoT *>(value) : nullptr;
  }
  const vxlnetworkapi::BlockInfoT *AsBlockInfo() const {
    return type == Message_BlockInfo ?
      reinterpret_cast<const vxlnetworkapi::BlockInfoT *>(value) : nullptr;
  }
  vxlnetworkapi::AccountWeightT *AsAccountWeight() {
    return type == Message_AccountWeight ?
      reinterpret_cast<vxlnetworkapi::AccountWeightT *>(value) : nullptr;
  }
  const vxlnetworkapi::AccountWeightT *AsAccountWeight() const {
    return type == Message_AccountWeight ?
      reinterpret_cast<const vxlnetworkapi::AccountWeightT *>(value) : nullptr;
  }
  vxlnetworkapi::AccountWeightResponseT *AsAccountWeightResponse() {
    return type == Message_AccountWeightResponse ?
      reinterpret_cast<vxlnetworkapi::AccountWeightResponseT *>(value) : nullptr;
  }
  const vxlnetworkapi::AccountWeightResponseT *AsAccountWeightResponse() const {
    return type == Message_AccountWeightResponse ?
      reinterpret_cast<const vxlnetworkapi::AccountWeightResponseT *>(value) : nullptr;
  }
  vxlnetworkapi::TopicConfirmationT *AsTopicConfirmation() {
    return type == Message_TopicConfirmation ?
      reinterpret_cast<vxlnetworkapi::TopicConfirmationT *>(value) : nullptr;
  }
  const vxlnetworkapi::TopicConfirmationT *AsTopicConfirmation() const {
    return type == Message_TopicConfirmation ?
      reinterpret_cast<const vxlnetworkapi::TopicConfirmationT *>(value) : nullptr;
  }
  vxlnetworkapi::EventConfirmationT *AsEventConfirmation() {
    return type == Message_EventConfirmation ?
      reinterpret_cast<vxlnetworkapi::EventConfirmationT *>(value) : nullptr;
  }
  const vxlnetworkapi::EventConfirmationT *AsEventConfirmation() const {
    return type == Message_EventConfirmation ?
      reinterpret_cast<const vxlnetworkapi::EventConfirmationT *>(value) : nullptr;
  }
  vxlnetworkapi::ServiceRegisterT *AsServiceRegister() {
    return type == Message_ServiceRegister ?
      reinterpret_cast<vxlnetworkapi::ServiceRegisterT *>(value) : nullptr;
  }
  const vxlnetworkapi::ServiceRegisterT *AsServiceRegister() const {
    return type == Message_ServiceRegister ?
      reinterpret_cast<const vxlnetworkapi::ServiceRegisterT *>(value) : nullptr;
  }
  vxlnetworkapi::ServiceStopT *AsServiceStop() {
    return type == Message_ServiceStop ?
      reinterpret_cast<vxlnetworkapi::ServiceStopT *>(value) : nullptr;
  }
  const vxlnetworkapi::ServiceStopT *AsServiceStop() const {
    return type == Message_ServiceStop ?
      reinterpret_cast<const vxlnetworkapi::ServiceStopT *>(value) : nullptr;
  }
  vxlnetworkapi::TopicServiceStopT *AsTopicServiceStop() {
    return type == Message_TopicServiceStop ?
      reinterpret_cast<vxlnetworkapi::TopicServiceStopT *>(value) : nullptr;
  }
  const vxlnetworkapi::TopicServiceStopT *AsTopicServiceStop() const {
    return type == Message_TopicServiceStop ?
      reinterpret_cast<const vxlnetworkapi::TopicServiceStopT *>(value) : nullptr;
  }
  vxlnetworkapi::EventServiceStopT *AsEventServiceStop() {
    return type == Message_EventServiceStop ?
      reinterpret_cast<vxlnetworkapi::EventServiceStopT *>(value) : nullptr;
  }
  const vxlnetworkapi::EventServiceStopT *AsEventServiceStop() const {
    return type == Message_EventServiceStop ?
      reinterpret_cast<const vxlnetworkapi::EventServiceStopT *>(value) : nullptr;
  }
};
...
struct AccountWeightT : public flatbuffers::NativeTable {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "vxlnetworkapi.AccountWeightT";
  }
  std::string account{};
};
...
struct AccountWeight FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "vxlnetworkapi.AccountWeight";
  }
...
inline flatbuffers::Offset<AccountWeight> CreateAccountWeightDirect(
  ...
  return vxlnetworkapi::CreateAccountWeight(
      _fbb,
      account__);
}
...
struct AccountWeightResponseT : public flatbuffers::NativeTable {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "vxlnetworkapi.AccountWeightResponseT";
  }
...
struct AccountWeightResponse FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "vxlnetworkapi.AccountWeightResponse";
  }
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_VOTING_WEIGHT = 4
  };
...
inline flatbuffers::Offset<AccountWeightResponse> CreateAccountWeightResponseDirect(
  ...
  return vxlnetworkapi::CreateAccountWeightResponse(
      _fbb,
      voting_weight__);
}
...
struct BlockOpenT : public flatbuffers::NativeTable {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "vxlnetworkapi.BlockOpenT";
  }
  std::string hash{};
  std::string account{};
  std::string source{};
...
struct BlockOpen FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "vxlnetworkapi.BlockOpen";
  }
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_HASH = 4,
    VT_ACCOUNT = 6,
...
inline flatbuffers::Offset<BlockOpen> CreateBlockOpenDirect(
  ...
  return vxlnetworkapi::CreateBlockOpen(
      _fbb,
      hash__,
      account__,
      source__,
...
struct BlockReceiveT : public flatbuffers::NativeTable {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "vxlnetworkapi.BlockReceiveT";
  }
  std::string hash{};
  std::string previous{};
  std::string source{};
...
struct BlockReceive FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "vxlnetworkapi.BlockReceive";
  }
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_HASH = 4,
    VT_PREVIOUS = 6,
...
inline flatbuffers::Offset<BlockReceive> CreateBlockReceiveDirect(
  ...
  auto signature__ = signature ? _fbb.CreateString(signature) : 0;
  auto work__ = work ? _fbb.CreateString(work) : 0;
  return vxlnetworkapi::CreateBlockReceive(
      _fbb,
      hash__,
      previous__,
      source__,
...
struct BlockSendT : public flatbuffers::NativeTable {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "vxlnetworkapi.BlockSendT";
  }
  std::string hash{};
  std::string previous{};
...
struct BlockSend FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "vxlnetworkapi.BlockSend";
  }
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_HASH = 4,
    VT_PREVIOUS = 6,
...
inline flatbuffers::Offset<BlockSend> CreateBlockSendDirect(
  ...
  auto signature__ = signature ? _fbb.CreateString(signature) : 0;
  auto work__ = work ? _fbb.CreateString(work) : 0;
  return vxlnetworkapi::CreateBlockSend(
      _fbb,
      hash__,
      previous__,
      destination__,
...
struct BlockChangeT : public flatbuffers::NativeTable {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "vxlnetworkapi.BlockChangeT";
  }
  std::string hash{};
  std::string previous{};
  std::string representative{};
...
struct BlockChange FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "vxlnetworkapi.BlockChange";
  }
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_HASH = 4,
    VT_PREVIOUS = 6,
...
inline flatbuffers::Offset<BlockChange> CreateBlockChangeDirect(
  ...
  auto signature__ = signature ? _fbb.CreateString(signature) : 0;
  auto work__ = work ? _fbb.CreateString(work) : 0;
  return vxlnetworkapi::CreateBlockChange(
      _fbb,
      hash__,
      previous__,
      representative__,
...
struct BlockStateT : public flatbuffers::NativeTable {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "vxlnetworkapi.BlockStateT";
  }
  std::string hash{};
  std::string account{};
  std::string previous{};
  ...
  std::string signature{};
  std::string work{};
  vxlnetworkapi::BlockSubType subtype = vxlnetworkapi::BlockSubType_invalid;
};
...
struct BlockState FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "vxlnetworkapi.BlockState";
  }
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_HASH = 4,
    VT_ACCOUNT = 6,
  ...
  vxlnetworkapi::BlockSubType subtype() const {
    return static_cast<vxlnetworkapi::BlockSubType>(GetField<int8_t>(VT_SUBTYPE, 0));
  }
  bool mutate_subtype(vxlnetworkapi::BlockSubType _subtype) {
...
struct BlockStateBuilder {
  ...
  void add_subtype(vxlnetworkapi::BlockSubType subtype) {
...
inline flatbuffers::Offset<BlockState> CreateBlockStateDirect(
  ...
  auto signature__ = signature ? _fbb.CreateString(signature) : 0;
  auto work__ = work ? _fbb.CreateString(work) : 0;
  return vxlnetworkapi::CreateBlockState(
      _fbb,
      hash__,
      account__,
      previous__,
...
struct BlockInfoT : public flatbuffers::NativeTable {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "vxlnetworkapi.BlockInfoT";
  }
...
struct BlockInfo FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "vxlnetworkapi.BlockInfo";
  }
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_BLOCK_TYPE = 4,
    VT_BLOCK = 6
  };
  vxlnetworkapi::Block block_type() const {
    return static_cast<vxlnetworkapi::Block>(GetField<uint8_t>(VT_BLOCK_TYPE, 0));
  }
  const void *block() const {
    return GetPointer<const void *>(VT_BLOCK);
  }
  template<typename T> const T *block_as() const;
  const vxlnetworkapi::BlockState *block_as_BlockState() const {
    return block_type() == vxlnetworkapi::Block_BlockState ? static_cast<const vxlnetworkapi::BlockState *>(block()) : nullptr;
  }
  const vxlnetworkapi::BlockOpen *block_as_BlockOpen() const {
    return block_type() == vxlnetworkapi::Block_BlockOpen ? static_cast<const vxlnetworkapi::BlockOpen *>(block()) : nullptr;
  }
  const vxlnetworkapi::BlockReceive *block_as_BlockReceive() const {
    return block_type() == vxlnetworkapi::Block_BlockReceive ? static_cast<const vxlnetworkapi::BlockReceive *>(block()) : nullptr;
  }
  const vxlnetworkapi::BlockSend *block_as_BlockSend() const {
    return block_type() == vxlnetworkapi::Block_BlockSend ? static_cast<const vxlnetworkapi::BlockSend *>(block()) : nullptr;
  }
  const vxlnetworkapi::BlockChange *block_as_BlockChange() const {
    return block_type() == vxlnetworkapi::Block_BlockChange ? static_cast<const vxlnetworkapi::BlockChange *>(block()) : nullptr;
  }
  void *mutable_block() {
...
template<> inline const vxlnetworkapi::BlockState *BlockInfo::block_as<vxlnetworkapi::BlockState>() const {
  return block_as_BlockState();
}

template<> inline const vxlnetworkapi::BlockOpen *BlockInfo::block_as<vxlnetworkapi::BlockOpen>() const {
  return block_as_BlockOpen();
}

template<> inline const vxlnetworkapi::BlockReceive *BlockInfo::block_as<vxlnetworkapi::BlockReceive>() const {
  return block_as_BlockReceive();
}

template<> inline const vxlnetworkapi::BlockSend *BlockInfo::block_as<vxlnetworkapi::BlockSend>() const {
  return block_as_BlockSend();
}

template<> inline const vxlnetworkapi::BlockChange *BlockInfo::block_as<vxlnetworkapi::BlockChange>() const {
...
struct BlockInfoBuilder {
  ...
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_block_type(vxlnetworkapi::Block block_type) {
...
inline flatbuffers::Offset<BlockInfo> CreateBlockInfo(
    flatbuffers::FlatBufferBuilder &_fbb,
    vxlnetworkapi::Block block_type = vxlnetworkapi::Block_NONE,
...
struct ServiceRegisterT : public flatbuffers::NativeTable {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "vxlnetworkapi.ServiceRegisterT";
  }
...
struct ServiceRegister FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "vxlnetworkapi.ServiceRegister";
  }
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_SERVICE_NAME = 4
  };
...
inline flatbuffers::Offset<ServiceRegister> CreateServiceRegisterDirect(
  ...
  return vxlnetworkapi::CreateServiceRegister(
      _fbb,
      service_name__);
}
...
struct ServiceStopT : public flatbuffers::NativeTable {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "vxlnetworkapi.ServiceStopT";
  }
  std::string service_name{};
  bool restart = false;
};
...
struct ServiceStop FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "vxlnetworkapi.ServiceStop";
  }
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_SERVICE_NAME = 4,
    VT_RESTART = 6
...
inline flatbuffers::Offset<ServiceStop> CreateServiceStopDirect(
    ...
    bool restart = false) {
  auto service_name__ = service_name ? _fbb.CreateString(service_name) : 0;
  return vxlnetworkapi::CreateServiceStop(
      _fbb,
      service_name__,
      restart);
}
...
struct TopicServiceStopT : public flatbuffers::NativeTable {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "vxlnetworkapi.TopicServiceStopT";
  }
...
struct TopicServiceStop FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "vxlnetworkapi.TopicServiceStop";
  }
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_UNSUBSCRIBE = 4
  };
...
struct EventServiceStopT : public flatbuffers::NativeTable {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "vxlnetworkapi.EventServiceStopT";
  }
};
...
struct EventServiceStop FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "vxlnetworkapi.EventServiceStop";
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           verifier.EndTable();
...
struct EventAckT : public flatbuffers::NativeTable {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "vxlnetworkapi.EventAckT";
  }
};
...
struct TopicConfirmationT : public flatbuffers::NativeTable {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "vxlnetworkapi.TopicConfirmationT";
  }
  bool unsubscribe = false;
  std::unique_ptr<vxlnetworkapi::TopicConfirmationOptionsT> options{};
};
...
struct TopicConfirmation FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "vxlnetworkapi.TopicConfirmation";
  }
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_UNSUBSCRIBE = 4,
    VT_OPTIONS = 6
  ...
  const vxlnetworkapi::TopicConfirmationOptions *options() const {
    return GetPointer<const vxlnetworkapi::TopicConfirmationOptions *>(VT_OPTIONS);
  }
  vxlnetworkapi::TopicConfirmationOptions *mutable_options() {
    return GetPointer<vxlnetworkapi::TopicConfirmationOptions *>(VT_OPTIONS);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<uint8_t>(verifier, VT_UNSUBSCRIBE) &&
...
struct TopicConfirmationBuilder {
  ...
  void add_options(flatbuffers::Offset<vxlnetworkapi::TopicConfirmationOptions> options) {
...
inline flatbuffers::Offset<TopicConfirmation> CreateTopicConfirmation(
    flatbuffers::FlatBufferBuilder &_fbb,
    bool unsubscribe = false,
    flatbuffers::Offset<vxlnetworkapi::TopicConfirmationOptions> options = 0) {
...
struct TopicConfirmationOptionsT : public flatbuffers::NativeTable {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "vxlnetworkapi.TopicConfirmationOptionsT";
  }
  vxlnetworkapi::TopicConfirmationTypeFilter confirmation_type_filter = vxlnetworkapi::TopicConfirmationTypeFilter_all;
...
struct TopicConfirmationOptions FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "vxlnetworkapi.TopicConfirmationOptions";
  }
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
  ...
  vxlnetworkapi::TopicConfirmationTypeFilter confirmation_type_filter() const {
    return static_cast<vxlnetworkapi::TopicConfirmationTypeFilter>(GetField<int8_t>(VT_CONFIRMATION_TYPE_FILTER, 0));
  }
  bool mutate_confirmation_type_filter(vxlnetworkapi::TopicConfirmationTypeFilter _confirmation_type_filter) {
...
struct TopicConfirmationOptionsBuilder {
  ...
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_confirmation_type_filter(vxlnetworkapi::TopicConfirmationTypeFilter confirmation_type_filter) {
...
inline flatbuffers::Offset<TopicConfirmationOptions> CreateTopicConfirmationOptionsDirect(
  ...
  return vxlnetworkapi::CreateTopicConfirmationOptions(
      _fbb,
...
struct EventConfirmationT : public flatbuffers::NativeTable {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "vxlnetworkapi.EventConfirmationT";
  }
  vxlnetworkapi::TopicConfirmationType confirmation_type = vxlnetworkapi::TopicConfirmationType_active_quorum;
  std::string account{};
  std::string amount{};
  std::string hash{};
  vxlnetworkapi::BlockUnion block{};
  std::unique_ptr<vxlnetworkapi::ElectionInfoT> election_info{};
};
...
struct EventConfirmation FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "vxlnetworkapi.EventConfirmation";
  }
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
  ...
  vxlnetworkapi::TopicConfirmationType confirmation_type() const {
    return static_cast<vxlnetworkapi::TopicConfirmationType>(GetField<int8_t>(VT_CONFIRMATION_TYPE, 0));
  }
  bool mutate_confirmation_type(vxlnetworkapi::TopicConfirmationType _confirmation_type) {
  ...
  const vxlnetworkapi::ElectionInfo *election_info() const {
    return GetPointer<const vxlnetworkapi::ElectionInfo *>(VT_ELECTION_INFO);
  }
  vxlnetworkapi::ElectionInfo *mutable_election_info() {
    return GetPointer<vxlnetworkapi::ElectionInfo *>(VT_ELECTION_INFO);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
template<> inline const vxlnetworkapi::BlockState *EventConfirmation::block_as<vxlnetworkapi::BlockState>() const {
  return block_as_BlockState();
}

template<> inline const vxlnetworkapi::BlockOpen *EventConfirmation::block_as<vxlnetworkapi::BlockOpen>() const {
  return block_as_BlockOpen();
}

template<> inline const vxlnetworkapi::BlockReceive *EventConfirmation::block_as<vxlnetworkapi::BlockReceive>() const {
  return block_as_BlockReceive();
}

template<> inline const vxlnetworkapi::BlockSend *EventConfirmation::block_as<vxlnetworkapi::BlockSend>() const {
  return block_as_BlockSend();
}

template<> inline const vxlnetworkapi::BlockChange *EventConfirmation::block_as<vxlnetworkapi::BlockChange>() const {
  return block_as_BlockChange();
}
...
struct EventConfirmationBuilder {
  ...
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_confirmation_type(vxlnetworkapi::TopicConfirmationType confirmation_type) {
  ...
  void add_election_info(flatbuffers::Offset<vxlnetworkapi::ElectionInfo> election_info) {
...
inline flatbuffers::Offset<EventConfirmation> CreateEventConfirmation(
    ...
    vxlnetworkapi::Block block_type = vxlnetworkapi::Block_NONE,
    flatbuffers::Offset<void> block = 0,
    flatbuffers::Offset<vxlnetworkapi::ElectionInfo> election_info = 0) {
...
inline flatbuffers::Offset<EventConfirmation> CreateEventConfirmationDirect(
  ...
  auto hash__ = hash ? _fbb.CreateString(hash) : 0;
  return vxlnetworkapi::CreateEventConfirmation(
      _fbb,
      confirmation_type,
      account__,
      amount__,
...
struct ElectionInfoT : public flatbuffers::NativeTable {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "vxlnetworkapi.ElectionInfoT";
  }
  uint64_t duration = 0;
  uint64_t time = 0;
  std::string tally{};
...
struct ElectionInfo FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "vxlnetworkapi.ElectionInfo";
  }
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_DURATION = 4,
    VT_TIME = 6,
...
inline flatbuffers::Offset<ElectionInfo> CreateElectionInfoDirect(
  ...
  return vxlnetworkapi::CreateElectionInfo(
      _fbb,
      duration,
      time,
      tally__,
...
inline flatbuffers::Offset<Error> CreateErrorDirect(
  ...
  return vxlnetworkapi::CreateError(
      _fbb,
      code,
      category,
      message__);
...
inline flatbuffers::Offset<Success> CreateSuccessDirect(
    ...
    const char *message = nullptr) {
  auto message__ = message ? _fbb.CreateString(message) : 0;
  return vxlnetworkapi::CreateSuccess(
      _fbb,
      message__);
}
...
struct EnvelopeT : public flatbuffers::NativeTable {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "vxlnetworkapi.EnvelopeT";
  }
  uint64_t time = 0;
  std::string credentials{};
  std::string correlation_id{};
  vxlnetworkapi::MessageUnion message{};
};
...
struct Envelope FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  vxlnetworkapi::Message message_type() const {
    return static_cast<vxlnetworkapi::Message>(GetField<uint8_t>(VT_MESSAGE_TYPE, 0));
  }
  const void *message() const {
    return GetPointer<const void *>(VT_MESSAGE);
  }
  template<typename T> const T *message_as() const;
  const vxlnetworkapi::Error *message_as_Error() const {
    return message_type() == vxlnetworkapi::Message_Error ? static_cast<const vxlnetworkapi::Error *>(message()) : nullptr;
  }
  const vxlnetworkapi::Success *message_as_Success() const {
    return message_type() == vxlnetworkapi::Message_Success ? static_cast<const vxlnetworkapi::Success *>(message()) : nullptr;
  }
  const vxlnetworkapi::IsAlive *message_as_IsAlive() const {
    return message_type() == vxlnetworkapi::Message_IsAlive ? static_cast<const vxlnetworkapi::IsAlive *>(message()) : nullptr;
  }
  const vxlnetworkapi::EventAck *message_as_EventAck() const {
    return message_type() == vxlnetworkapi::Message_EventAck ? static_cast<const vxlnetworkapi::EventAck *>(message()) : nullptr;
  }
  const vxlnetworkapi::BlockInfo *message_as_BlockInfo() const {
    return message_type() == vxlnetworkapi::Message_BlockInfo ? static_cast<const vxlnetworkapi::BlockInfo *>(message()) : nullptr;
  }
  const vxlnetworkapi::AccountWeight *message_as_AccountWeight() const {
    return message_type() == vxlnetworkapi::Message_AccountWeight ? static_cast<const vxlnetworkapi::AccountWeight *>(message()) : nullptr;
  }
  const vxlnetworkapi::AccountWeightResponse *message_as_AccountWeightResponse() const {
    return message_type() == vxlnetworkapi::Message_AccountWeightResponse ? static_cast<const vxlnetworkapi::AccountWeightResponse *>(message()) : nullptr;
  }
  const vxlnetworkapi::TopicConfirmation *message_as_TopicConfirmation() const {
    return message_type() == vxlnetworkapi::Message_TopicConfirmation ? static_cast<const vxlnetworkapi::TopicConfirmation *>(message()) : nullptr;
  }
  const vxlnetworkapi::EventConfirmation *message_as_EventConfirmation() const {
    return message_type() == vxlnetworkapi::Message_EventConfirmation ? static_cast<const vxlnetworkapi::EventConfirmation *>(message()) : nullptr;
  }
  const vxlnetworkapi::ServiceRegister *message_as_ServiceRegister() const {
    return message_type() == vxlnetworkapi::Message_ServiceRegister ? static_cast<const vxlnetworkapi::ServiceRegister *>(message()) : nullptr;
  }
  const vxlnetworkapi::ServiceStop *message_as_ServiceStop() const {
    return message_type() == vxlnetworkapi::Message_ServiceStop ? static_cast<const vxlnetworkapi::ServiceStop *>(message()) : nullptr;
  }
  const vxlnetworkapi::TopicServiceStop *message_as_TopicServiceStop() const {
    return message_type() == vxlnetworkapi::Message_TopicServiceStop ? static_cast<const vxlnetworkapi::TopicServiceStop *>(message()) : nullptr;
  }
  const vxlnetworkapi::EventServiceStop *message_as_EventServiceStop() const {
    return message_type() == vxlnetworkapi::Message_EventServiceStop ? static_cast<const vxlnetworkapi::EventServiceStop *>(message()) : nullptr;
  }
...
template<> inline const vxlnetworkapi::Error *Envelope::message_as<vxlnetworkapi::Error>() const {
  return message_as_Error();
}

template<> inline const vxlnetworkapi::Success *Envelope::message_as<vxlnetworkapi::Success>() const {
  return message_as_Success();
}

template<> inline const vxlnetworkapi::IsAlive *Envelope::message_as<vxlnetworkapi::IsAlive>() const {
  return message_as_IsAlive();
}

template<> inline const vxlnetworkapi::EventAck *Envelope::message_as<vxlnetworkapi::EventAck>() const {
  return message_as_EventAck();
}

template<> inline const vxlnetworkapi::BlockInfo *Envelope::message_as<vxlnetworkapi::BlockInfo>() const {
  return message_as_BlockInfo();
}

template<> inline const vxlnetworkapi::AccountWeight *Envelope::message_as<vxlnetworkapi::AccountWeight>() const {
  return message_as_AccountWeight();
}

template<> inline const vxlnetworkapi::AccountWeightResponse *Envelope::message_as<vxlnetworkapi::AccountWeightResponse>() const {
  return message_as_AccountWeightResponse();
}

template<> inline const vxlnetworkapi::TopicConfirmation *Envelope::message_as<vxlnetworkapi::TopicConfirmation>() const {
  return message_as_TopicConfirmation();
}

template<> inline const vxlnetworkapi::EventConfirmation *Envelope::message_as<vxlnetworkapi::EventConfirmation>() const {
  return message_as_EventConfirmation();
}

template<> inline const vxlnetworkapi::ServiceRegister *Envelope::message_as<vxlnetworkapi::ServiceRegister>() const {
  return message_as_ServiceRegister();
}

template<> inline const vxlnetworkapi::ServiceStop *Envelope::message_as<vxlnetworkapi::ServiceStop>() const {
  return message_as_ServiceStop();
}

template<> inline const vxlnetworkapi::TopicServiceStop *Envelope::message_as<vxlnetworkapi::TopicServiceStop>() const {
  return message_as_TopicServiceStop();
}

template<> inline const vxlnetworkapi::EventServiceStop *Envelope::message_as<vxlnetworkapi::EventServiceStop>() const {
...
struct EnvelopeBuilder {
  ...
  void add_message_type(vxlnetworkapi::Message message_type) {
...
inline flatbuffers::Offset<Envelope> CreateEnvelope(
    ...
    vxlnetworkapi::Message message_type = vxlnetworkapi::Message_NONE,
...
inline flatbuffers::Offset<Envelope> CreateEnvelopeDirect(
  ...
  return vxlnetworkapi::CreateEnvelope(
      _fbb,
      time,
      credentials__,
      correlation_id__,
...
inline AccountWeightT *AccountWeight::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  auto _o = std::unique_ptr<AccountWeightT>(new AccountWeightT());
...
inline AccountWeightResponseT *AccountWeightResponse::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  auto _o = std::unique_ptr<AccountWeightResponseT>(new AccountWeightResponseT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}
...
inline BlockOpenT *BlockOpen::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  auto _o = std::unique_ptr<BlockOpenT>(new BlockOpenT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}
...
inline BlockReceiveT *BlockReceive::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  auto _o = std::unique_ptr<BlockReceiveT>(new BlockReceiveT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}
...
inline BlockSendT *BlockSend::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  auto _o = std::unique_ptr<BlockSendT>(new BlockSendT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}
...
inline BlockChangeT *BlockChange::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  auto _o = std::unique_ptr<BlockChangeT>(new BlockChangeT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}
...
inline BlockStateT *BlockState::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  auto _o = std::unique_ptr<BlockStateT>(new BlockStateT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}
...
inline BlockInfoT *BlockInfo::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  auto _o = std::unique_ptr<BlockInfoT>(new BlockInfoT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}
...
inline void BlockInfo::UnPackTo(BlockInfoT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  ...
  { auto _e = block(); if (_e) _o->block.value = vxlnetworkapi::BlockUnion::UnPack(_e, block_type(), _resolver); }
}
...
inline flatbuffers::Offset<BlockInfo> CreateBlockInfo(flatbuffers::FlatBufferBuilder &_fbb, const BlockInfoT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  ...
  return vxlnetworkapi::CreateBlockInfo(
      _fbb,
      _block_type,
      _block);
}
...
inline ServiceRegisterT *ServiceRegister::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  auto _o = std::unique_ptr<ServiceRegisterT>(new ServiceRegisterT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}
...
inline ServiceStopT *ServiceStop::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  auto _o = std::unique_ptr<ServiceStopT>(new ServiceStopT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}
...
inline TopicServiceStopT *TopicServiceStop::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  auto _o = std::unique_ptr<TopicServiceStopT>(new TopicServiceStopT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}
...
inline flatbuffers::Offset<TopicServiceStop> CreateTopicServiceStop(flatbuffers::FlatBufferBuilder &_fbb, const TopicServiceStopT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  ...
  return vxlnetworkapi::CreateTopicServiceStop(
      _fbb,
      _unsubscribe);
}

inline EventServiceStopT *EventServiceStop::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  auto _o = std::unique_ptr<EventServiceStopT>(new EventServiceStopT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}
...
inline flatbuffers::Offset<EventServiceStop> CreateEventServiceStop(flatbuffers::FlatBufferBuilder &_fbb, const EventServiceStopT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  ...
  return vxlnetworkapi::CreateEventServiceStop(
      _fbb);
}

inline EventAckT *EventAck::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  auto _o = std::unique_ptr<EventAckT>(new EventAckT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}
...
inline void TopicConfirmation::UnPackTo(TopicConfirmationT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  ...
  (void)_resolver;
  { auto _e = unsubscribe(); _o->unsubscribe = _e; }
  { auto _e = options(); if (_e) _o->options = std::unique_ptr<vxlnetworkapi::TopicConfirmationOptionsT>(_e->UnPack(_resolver)); }
}
...
inline flatbuffers::Offset<TopicConfirmation> CreateTopicConfirmation(flatbuffers::FlatBufferBuilder &_fbb, const TopicConfirmationT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  ...
  return vxlnetworkapi::CreateTopicConfirmation(
      _fbb,
      _unsubscribe,
      _options);
}
...
inline TopicConfirmationOptionsT *TopicConfirmationOptions::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  auto _o = std::unique_ptr<TopicConfirmationOptionsT>(new TopicConfirmationOptionsT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}
...
inline EventConfirmationT *EventConfirmation::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  auto _o = std::unique_ptr<EventConfirmationT>(new EventConfirmationT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}
...
inline void EventConfirmation::UnPackTo(EventConfirmationT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  ...
  { auto _e = block_type(); _o->block.type = _e; }
  { auto _e = block(); if (_e) _o->block.value = vxlnetworkapi::BlockUnion::UnPack(_e, block_type(), _resolver); }
  { auto _e = election_info(); if (_e) _o->election_info = std::unique_ptr<vxlnetworkapi::ElectionInfoT>(_e->UnPack(_resolver)); }
}
...
inline ElectionInfoT *ElectionInfo::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  auto _o = std::unique_ptr<ElectionInfoT>(new ElectionInfoT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}
...
inline SuccessT *Success::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  auto _o = std::unique_ptr<SuccessT>(new SuccessT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}
...
inline IsAliveT *IsAlive::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  auto _o = std::unique_ptr<IsAliveT>(new IsAliveT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}
...
inline flatbuffers::Offset<IsAlive> CreateIsAlive(flatbuffers::FlatBufferBuilder &_fbb, const IsAliveT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  ...
  return vxlnetworkapi::CreateIsAlive(
      _fbb);
}
...
inline void Envelope::UnPackTo(EnvelopeT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  ...
  { auto _e = message(); if (_e) _o->message.value = vxlnetworkapi::MessageUnion::UnPack(_e, message_type(), _resolver); }
}
...
inline bool VerifyBlock(flatbuffers::Verifier &verifier, const void *obj, Block type) {
  switch (type) {
    ...
    case Block_BlockState: {
      auto ptr = reinterpret_cast<const vxlnetworkapi::BlockState *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case Block_BlockOpen: {
      auto ptr = reinterpret_cast<const vxlnetworkapi::BlockOpen *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case Block_BlockReceive: {
      auto ptr = reinterpret_cast<const vxlnetworkapi::BlockReceive *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case Block_BlockSend: {
      auto ptr = reinterpret_cast<const vxlnetworkapi::BlockSend *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case Block_BlockChange: {
      auto ptr = reinterpret_cast<const vxlnetworkapi::BlockChange *>(obj);
      return verifier.VerifyTable(ptr);
    }
    default: return true;
  }
...
inline flatbuffers::Offset<void> BlockUnion::Pack(flatbuffers::FlatBufferBuilder &_fbb, const flatbuffers::rehasher_function_t *_rehasher) const {
  switch (type) {
    case Block_BlockState: {
      auto ptr = reinterpret_cast<const vxlnetworkapi::BlockStateT *>(value);
      return CreateBlockState(_fbb, ptr, _rehasher).Union();
    }
    case Block_BlockOpen: {
      auto ptr = reinterpret_cast<const vxlnetworkapi::BlockOpenT *>(value);
      return CreateBlockOpen(_fbb, ptr, _rehasher).Union();
    }
    case Block_BlockReceive: {
      auto ptr = reinterpret_cast<const vxlnetworkapi::BlockReceiveT *>(value);
      return CreateBlockReceive(_fbb, ptr, _rehasher).Union();
    }
    case Block_BlockSend: {
      auto ptr = reinterpret_cast<const vxlnetworkapi::BlockSendT *>(value);
      return CreateBlockSend(_fbb, ptr, _rehasher).Union();
    }
    case Block_BlockChange: {
      auto ptr = reinterpret_cast<const vxlnetworkapi::BlockChangeT *>(value);
...
inline BlockUnion::BlockUnion(const BlockUnion &u) : type(u.type), value(nullptr) {
  switch (type) {
    case Block_BlockState: {
      value = new vxlnetworkapi::BlockStateT(*reinterpret_cast<vxlnetworkapi::BlockStateT *>(u.value));
      break;
    }
    case Block_BlockOpen: {
      value = new vxlnetworkapi::BlockOpenT(*reinterpret_cast<vxlnetworkapi::BlockOpenT *>(u.value));
      break;
    }
    case Block_BlockReceive: {
      value = new vxlnetworkapi::BlockReceiveT(*reinterpret_cast<vxlnetworkapi::BlockReceiveT *>(u.value));
      break;
    }
    case Block_BlockSend: {
      value = new vxlnetworkapi::BlockSendT(*reinterpret_cast<vxlnetworkapi::BlockSendT *>(u.value));
      break;
    }
    case Block_BlockChange: {
      value = new vxlnetworkapi::BlockChangeT(*reinterpret_cast<vxlnetworkapi::BlockChangeT *>(u.value));
      break;
    }
    default:
      break;
...
inline void BlockUnion::Reset() {
  switch (type) {
    case Block_BlockState: {
      auto ptr = reinterpret_cast<vxlnetworkapi::BlockStateT *>(value);
      delete ptr;
      break;
    }
    case Block_BlockOpen: {
      auto ptr = reinterpret_cast<vxlnetworkapi::BlockOpenT *>(value);
      delete ptr;
      break;
    }
    case Block_BlockReceive: {
      auto ptr = reinterpret_cast<vxlnetworkapi::BlockReceiveT *>(value);
      delete ptr;
      break;
    }
    case Block_BlockSend: {
      auto ptr = reinterpret_cast<vxlnetworkapi::BlockSendT *>(value);
      delete ptr;
      break;
    }
    case Block_BlockChange: {
      auto ptr = reinterpret_cast<vxlnetworkapi::BlockChangeT *>(value);
      delete ptr;
      break;
    }
    default: break;
...
inline bool VerifyMessage(flatbuffers::Verifier &verifier, const void *obj, Message type) {
  switch (type) {
    ...
    case Message_Error: {
      auto ptr = reinterpret_cast<const vxlnetworkapi::Error *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case Message_Success: {
      auto ptr = reinterpret_cast<const vxlnetworkapi::Success *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case Message_IsAlive: {
      auto ptr = reinterpret_cast<const vxlnetworkapi::IsAlive *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case Message_EventAck: {
      auto ptr = reinterpret_cast<const vxlnetworkapi::EventAck *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case Message_BlockInfo: {
      auto ptr = reinterpret_cast<const vxlnetworkapi::BlockInfo *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case Message_AccountWeight: {
      auto ptr = reinterpret_cast<const vxlnetworkapi::AccountWeight *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case Message_AccountWeightResponse: {
      auto ptr = reinterpret_cast<const vxlnetworkapi::AccountWeightResponse *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case Message_TopicConfirmation: {
      auto ptr = reinterpret_cast<const vxlnetworkapi::TopicConfirmation *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case Message_EventConfirmation: {
      auto ptr = reinterpret_cast<const vxlnetworkapi::EventConfirmation *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case Message_ServiceRegister: {
      auto ptr = reinterpret_cast<const vxlnetworkapi::ServiceRegister *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case Message_ServiceStop: {
      auto ptr = reinterpret_cast<const vxlnetworkapi::ServiceStop *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case Message_TopicServiceStop: {
      auto ptr = reinterpret_cast<const vxlnetworkapi::TopicServiceStop *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case Message_EventServiceStop: {
      auto ptr = reinterpret_cast<const vxlnetworkapi::EventServiceStop *>(obj);
      return verifier.VerifyTable(ptr);
    }
    default: return true;
  }
...
inline flatbuffers::Offset<void> MessageUnion::Pack(flatbuffers::FlatBufferBuilder &_fbb, const flatbuffers::rehasher_function_t *_rehasher) const {
  switch (type) {
    case Message_Error: {
      auto ptr = reinterpret_cast<const vxlnetworkapi::ErrorT *>(value);
      return CreateError(_fbb, ptr, _rehasher).Union();
    }
    case Message_Success: {
      auto ptr = reinterpret_cast<const vxlnetworkapi::SuccessT *>(value);
      return CreateSuccess(_fbb, ptr, _rehasher).Union();
    }
    case Message_IsAlive: {
      auto ptr = reinterpret_cast<const vxlnetworkapi::IsAliveT *>(value);
      return CreateIsAlive(_fbb, ptr, _rehasher).Union();
    }
    case Message_EventAck: {
      auto ptr = reinterpret_cast<const vxlnetworkapi::EventAckT *>(value);
      return CreateEventAck(_fbb, ptr, _rehasher).Union();
    }
    case Message_BlockInfo: {
      auto ptr = reinterpret_cast<const vxlnetworkapi::BlockInfoT *>(value);
      return CreateBlockInfo(_fbb, ptr, _rehasher).Union();
    }
    case Message_AccountWeight: {
      auto ptr = reinterpret_cast<const vxlnetworkapi::AccountWeightT *>(value);
      return CreateAccountWeight(_fbb, ptr, _rehasher).Union();
    }
    case Message_AccountWeightResponse: {
      auto ptr = reinterpret_cast<const vxlnetworkapi::AccountWeightResponseT *>(value);
      return CreateAccountWeightResponse(_fbb, ptr, _rehasher).Union();
    }
    case Message_TopicConfirmation: {
      auto ptr = reinterpret_cast<const vxlnetworkapi::TopicConfirmationT *>(value);
      return CreateTopicConfirmation(_fbb, ptr, _rehasher).Union();
    }
    case Message_EventConfirmation: {
      auto ptr = reinterpret_cast<const vxlnetworkapi::EventConfirmationT *>(value);
      return CreateEventConfirmation(_fbb, ptr, _rehasher).Union();
    }
    case Message_ServiceRegister: {
      auto ptr = reinterpret_cast<const vxlnetworkapi::ServiceRegisterT *>(value);
      return CreateServiceRegister(_fbb, ptr, _rehasher).Union();
    }
    case Message_ServiceStop: {
      auto ptr = reinterpret_cast<const vxlnetworkapi::ServiceStopT *>(value);
      return CreateServiceStop(_fbb, ptr, _rehasher).Union();
    }
    case Message_TopicServiceStop: {
      auto ptr = reinterpret_cast<const vxlnetworkapi::TopicServiceStopT *>(value);
      return CreateTopicServiceStop(_fbb, ptr, _rehasher).Union();
    }
    case Message_EventServiceStop: {
      auto ptr = reinterpret_cast<const vxlnetworkapi::EventServiceStopT *>(value);
...
inline MessageUnion::MessageUnion(const MessageUnion &u) : type(u.type), value(nullptr) {
  switch (type) {
    case Message_Error: {
      value = new vxlnetworkapi::ErrorT(*reinterpret_cast<vxlnetworkapi::ErrorT *>(u.value));
      break;
    }
    case Message_Success: {
      value = new vxlnetworkapi::SuccessT(*reinterpret_cast<vxlnetworkapi::SuccessT *>(u.value));
      break;
    }
    case Message_IsAlive: {
      value = new vxlnetworkapi::IsAliveT(*reinterpret_cast<vxlnetworkapi::IsAliveT *>(u.value));
      break;
    }
    case Message_EventAck: {
      value = new vxlnetworkapi::EventAckT(*reinterpret_cast<vxlnetworkapi::EventAckT *>(u.value));
      break;
    }
    case Message_BlockInfo: {
      value = new vxlnetworkapi::BlockInfoT(*reinterpret_cast<vxlnetworkapi::BlockInfoT *>(u.value));
      break;
    }
    case Message_AccountWeight: {
      value = new vxlnetworkapi::AccountWeightT(*reinterpret_cast<vxlnetworkapi::AccountWeightT *>(u.value));
      break;
    }
    case Message_AccountWeightResponse: {
      value = new vxlnetworkapi::AccountWeightResponseT(*reinterpret_cast<vxlnetworkapi::AccountWeightResponseT *>(u.value));
      break;
    }
    case Message_TopicConfirmation: {
      FLATBUFFERS_ASSERT(false);  // vxlnetworkapi::TopicConfirmationT not copyable.
      break;
    }
    case Message_EventConfirmation: {
      FLATBUFFERS_ASSERT(false);  // vxlnetworkapi::EventConfirmationT not copyable.
      break;
    }
    case Message_ServiceRegister: {
      value = new vxlnetworkapi::ServiceRegisterT(*reinterpret_cast<vxlnetworkapi::ServiceRegisterT *>(u.value));
      break;
    }
    case Message_ServiceStop: {
      value = new vxlnetworkapi::ServiceStopT(*reinterpret_cast<vxlnetworkapi::ServiceStopT *>(u.value));
      break;
    }
    case Message_TopicServiceStop: {
      value = new vxlnetworkapi::TopicServiceStopT(*reinterpret_cast<vxlnetworkapi::TopicServiceStopT *>(u.value));
      break;
    }
    case Message_EventServiceStop: {
      value = new vxlnetworkapi::EventServiceStopT(*reinterpret_cast<vxlnetworkapi::EventServiceStopT *>(u.value));
      break;
    }
    default:
      break;
...
inline void MessageUnion::Reset() {
  switch (type) {
    case Message_Error: {
      auto ptr = reinterpret_cast<vxlnetworkapi::ErrorT *>(value);
      delete ptr;
      break;
    }
    case Message_Success: {
      auto ptr = reinterpret_cast<vxlnetworkapi::SuccessT *>(value);
      delete ptr;
      break;
    }
    case Message_IsAlive: {
      auto ptr = reinterpret_cast<vxlnetworkapi::IsAliveT *>(value);
      delete ptr;
      break;
    }
    case Message_EventAck: {
      auto ptr = reinterpret_cast<vxlnetworkapi::EventAckT *>(value);
      delete ptr;
      break;
    }
    case Message_BlockInfo: {
      auto ptr = reinterpret_cast<vxlnetworkapi::BlockInfoT *>(value);
      delete ptr;
      break;
    }
    case Message_AccountWeight: {
      auto ptr = reinterpret_cast<vxlnetworkapi::AccountWeightT *>(value);
      delete ptr;
      break;
    }
    case Message_AccountWeightResponse: {
      auto ptr = reinterpret_cast<vxlnetworkapi::AccountWeightResponseT *>(value);
      delete ptr;
      break;
    }
    case Message_TopicConfirmation: {
      auto ptr = reinterpret_cast<vxlnetworkapi::TopicConfirmationT *>(value);
      delete ptr;
      break;
    }
    case Message_EventConfirmation: {
      auto ptr = reinterpret_cast<vxlnetworkapi::EventConfirmationT *>(value);
      delete ptr;
      break;
    }
    case Message_ServiceRegister: {
      auto ptr = reinterpret_cast<vxlnetworkapi::ServiceRegisterT *>(value);
      delete ptr;
      break;
    }
    case Message_ServiceStop: {
      auto ptr = reinterpret_cast<vxlnetworkapi::ServiceStopT *>(value);
      delete ptr;
      break;
    }
    case Message_TopicServiceStop: {
      auto ptr = reinterpret_cast<vxlnetworkapi::TopicServiceStopT *>(value);
      delete ptr;
      break;
    }
    case Message_EventServiceStop: {
      auto ptr = reinterpret_cast<vxlnetworkapi::EventServiceStopT *>(value);
      delete ptr;
      break;
    }
    default: break;
...
inline const flatbuffers::TypeTable *BlockSubTypeTypeTable() {
  ...
  static const flatbuffers::TypeFunction type_refs[] = {
    vxlnetworkapi::BlockSubTypeTypeTable
  };
...
inline const flatbuffers::TypeTable *BlockTypeTable() {
  ...
  static const flatbuffers::TypeFunction type_refs[] = {
    vxlnetworkapi::BlockStateTypeTable,
    vxlnetworkapi::BlockOpenTypeTable,
    vxlnetworkapi::BlockReceiveTypeTable,
    vxlnetworkapi::BlockSendTypeTable,
    vxlnetworkapi::BlockChangeTypeTable
  };
  static const char * const names[] = {
    "NONE",
    "BlockState",
...
inline const flatbuffers::TypeTable *TopicConfirmationTypeFilterTypeTable() {
  ...
  static const flatbuffers::TypeFunction type_refs[] = {
    vxlnetworkapi::TopicConfirmationTypeFilterTypeTable
  };
  static const char * const names[] = {
    "all",
    "active",
...
inline const flatbuffers::TypeTable *TopicConfirmationTypeTypeTable() {
  ...
  static const flatbuffers::TypeFunction type_refs[] = {
    vxlnetworkapi::TopicConfirmationTypeTypeTable
  };
  static const char * const names[] = {
    "active_quorum",
    "active_confirmation_height",
...
inline const flatbuffers::TypeTable *MessageTypeTable() {
  ...
  static const flatbuffers::TypeFunction type_refs[] = {
    vxlnetworkapi::ErrorTypeTable,
    vxlnetworkapi::SuccessTypeTable,
    vxlnetworkapi::IsAliveTypeTable,
    vxlnetworkapi::EventAckTypeTable,
    vxlnetworkapi::BlockInfoTypeTable,
    vxlnetworkapi::AccountWeightTypeTable,
    vxlnetworkapi::AccountWeightResponseTypeTable,
    vxlnetworkapi::TopicConfirmationTypeTable,
    vxlnetworkapi::EventConfirmationTypeTable,
    vxlnetworkapi::ServiceRegisterTypeTable,
    vxlnetworkapi::ServiceStopTypeTable,
    vxlnetworkapi::TopicServiceStopTypeTable,
    vxlnetworkapi::EventServiceStopTypeTable
  };
  static const char * const names[] = {
    "NONE",
    "Error",
...
inline const flatbuffers::TypeTable *TopicConfirmationTypeTable() {
  ...
  static const flatbuffers::TypeFunction type_refs[] = {
    vxlnetworkapi::TopicConfirmationOptionsTypeTable
  };
  static const char * const names[] = {
    "unsubscribe",
    "options"
...
inline const flatbuffers::TypeTable *EventConfirmationTypeTable() {
  ...
  static const flatbuffers::TypeFunction type_refs[] = {
    vxlnetworkapi::TopicConfirmationTypeTypeTable,
    vxlnetworkapi::BlockTypeTable,
    vxlnetworkapi::ElectionInfoTypeTable
  };
  static const char * const names[] = {
    "confirmation_type",
    "account",
...
inline const flatbuffers::TypeTable *EnvelopeTypeTable() {
  ...
  static const flatbuffers::TypeFunction type_refs[] = {
    vxlnetworkapi::MessageTypeTable
  };
  static const char * const names[] = {
    "time",
    "credentials",
...
inline const vxlnetworkapi::Envelope *GetEnvelope(const void *buf) {
  return flatbuffers::GetRoot<vxlnetworkapi::Envelope>(buf);
}

inline const vxlnetworkapi::Envelope *GetSizePrefixedEnvelope(const void *buf) {
  return flatbuffers::GetSizePrefixedRoot<vxlnetworkapi::Envelope>(buf);
}
...
inline bool VerifyEnvelopeBuffer(
  ...
  return verifier.VerifyBuffer<vxlnetworkapi::Envelope>(nullptr);
}

inline bool VerifySizePrefixedEnvelopeBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<vxlnetworkapi::Envelope>(nullptr);
}

inline void FinishEnvelopeBuffer(
    flatbuffers::FlatBufferBuilder &fbb,
    flatbuffers::Offset<vxlnetworkapi::Envelope> root) {
  fbb.Finish(root);
}
...
inline std::unique_ptr<vxlnetworkapi::EnvelopeT> UnPackEnvelope(
    const void *buf,
    const flatbuffers::resolver_function_t *res = nullptr) {
  return std::unique_ptr<vxlnetworkapi::EnvelopeT>(GetEnvelope(buf)->UnPack(res));
}

inline std::unique_ptr<vxlnetworkapi::EnvelopeT> UnPackSizePrefixedEnvelope(
    const void *buf,
    const flatbuffers::resolver_function_t *res = nullptr) {
  return std::unique_ptr<vxlnetworkapi::EnvelopeT>(GetSizePrefixedEnvelope(buf)->UnPack(res));
}

}  // namespace vxlnetworkapi

#endif  // FLATBUFFERS_GENERATED_VXLNETWORKAPI_VXLNETWORKAPI_H_

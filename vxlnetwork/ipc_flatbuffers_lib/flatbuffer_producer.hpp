...
namespace ipc
{
	/** Produces Vxlnetwork API compliant Flatbuffers from objects and builders */
	...
	public:
		...
		{
			vxlnetwork::ipc::flatbuffer_producer producer;
		...
		auto make_envelope (flatbuffers::Offset<T> obj)
		{
			...
			vxlnetworkapi::EnvelopeBuilder envelope_builder (*fbb);
			...
			envelope_builder.add_message_type (vxlnetworkapi::MessageTraits<T>::enum_value);

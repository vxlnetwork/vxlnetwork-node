...
extern vxlnetwork::uint128_t const & genesis_amount;
...
namespace util
{
	...
	public:
		...
		{
			vxlnetwork::timer<UNIT> timer (vxlnetwork::timer_state::started);
			bool error = true;
...
void wait_peer_connections (vxlnetwork::system &);
}

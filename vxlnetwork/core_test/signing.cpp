...
{
	vxlnetwork::signature_checker checker (0);
	vxlnetwork::signature_check_set check = { 0, nullptr, nullptr, nullptr, nullptr, nullptr };
...
{
	vxlnetwork::signature_checker checker (4);
	...
	auto signature_checker_work_func = [&checker] () {
		...
		vxlnetwork::state_block invalid_block (key.pub, 0, key.pub, 0, 0, key.prv, key.pub, 0);
		...
		std::vector<vxlnetwork::signature_check_set> signature_checker_sets;
...
TEST (signature_checker, boundary_checks)
{
	...
	vxlnetwork::signature_checker checker (1);

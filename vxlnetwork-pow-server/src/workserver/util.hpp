...
inline double to_multiplier (vxlnetwork_pow_server::u128 const difficulty_a, vxlnetwork_pow_server::u128 const base_difficulty_a)
{
...
inline vxlnetwork_pow_server::u128 from_multiplier (double const multiplier_a, vxlnetwork_pow_server::u128 const base_difficulty_a)
{
